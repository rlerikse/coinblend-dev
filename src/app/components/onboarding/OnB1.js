...
class OnB1 extends React.Component {
    ...
    headerRight: <TouchableOpacity
                    onPress={() => {
                      ...
                      .then(data => {
                        ...
                        this.props.navigation.navigate('OnB2');
                      })
  ...
  constructor(props) {
    super(props);
    this.state = {
      question: 'When you think about digital assets, which of the following words come to mind first?',
      a0: 'Dangerous or scary',
      a1: 'Uncertainty or unpredictability',
      a2: 'Opportunity',
      a3: 'Other',
      apiResponse: null,
    };
