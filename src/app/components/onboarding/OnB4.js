...
class OnB4 extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      question: "The digital asset    market is often volatile. If your entire portfolio lost 25% of its value in a month during a market decline, what would you do?",
      a0: 'Sell all of your investment',
      a1: 'Sell some',
      a2: 'Keep all',
      a3: 'Buy more',
      apiResponse: null,
